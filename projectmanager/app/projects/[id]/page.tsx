            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              {rootTasks.length === 0 ? (
                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  {rootTasks.map((task) => (
                    <div key={task._id} className="border-b last:border-b-0">
                      <div 
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div>
                            <span className="font-medium">Задача {task.title}</span>
                            <span 
                      ...
                      {expandedTasks[task._id] && (
                        <div className="bg-gray-50 pl-10 pr-4 py-2 border-t">
